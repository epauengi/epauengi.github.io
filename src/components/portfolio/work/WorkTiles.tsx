    ...
    <section className={`section work-tiles portfolio-work-tiles grid-fade grid-columns-part${view === "columns" ? " visible" : ""}${phase === "idle" ? "" : ` grid-fade-${phase}`}`} aria-hidden={view !== "columns"}>
      <div className="container"><ul>
        {WORK_PROJECTS.map((project) => {
          ...
          const hasSeparateDemo = project.demo !== project.github;
          const mainActionLabel = hasSeparateDemo ? content.work.demo : content.work.source;
          return (
                ...
                <div className="row">
                  ...
                  <div className="flex-col portfolio-project-content">
                    ...
                    <div className="portfolio-project-actions">
                      {hasSeparateDemo && (
                        <a href={project.demo} target="_blank" rel="noreferrer">{content.work.demo}</a>
                      )}
                      <a href={project.github} target="_blank" rel="noreferrer">{content.work.source}</a>
                    </div>
                  </div>
                </div>
              </div>
