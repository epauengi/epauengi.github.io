...
export function JavaScriptIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        d="M67.3 100.8c3.2 5.2 7.7 8.5 15.4 8.5 6.4 0 10.6-3.2 10.6-7.6 0-5.3-4.2-7.2-11.3-10.3l-3.9-1.7c-11.2-4.8-18.6-10.8-18.6-23.4 0-11.6 9-20.5 23-20.5 10 0 17.2 3.5 22.3 12.3l-9.8 6.3c-2.4-4.3-5.3-6.1-12.5-6.1-5.1 0-8.9 3.2-8.9 7 0 4.4 3.5 6.3 9.7 8.9l3.9 1.7c13.2 5.7 20.4 11.4 20.4 24.5 0 14-11 21.6-25.7 21.6-14.4 0-23.6-7-27.9-15.6l13.3-5.6zM26.2 101.4l11.4-6.9c2.3 3.9 4.3 7.2 8.7 7.2 4.4 0 7.2-1.8 7.2-8.8V47.5h14v45.6c0 14.5-8.5 21-21.2 21-11.5 0-17.7-6-20.1-12.7z"
        fill="#000"
      />
    </svg>
  );
