        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <a 
              ...
              className="bg-primary-container border border-primary-container text-on-primary-fixed px-10 py-5 font-mono text-sm tracking-[0.15em] font-medium hover:bg-transparent hover:text-primary-container transition-all duration-300 text-center"
            >
              {t.contact.emailBtn}
            </a>
            <a 
              href="#" 
              className="border border-outline-variant text-on-surface px-10 py-5 font-mono text-sm tracking-[0.15em] font-medium hover:border-primary-container hover:text-primary-container transition-all duration-300 text-center"
            >
              {t.contact.resumeBtn}
            </a>
          </div>
